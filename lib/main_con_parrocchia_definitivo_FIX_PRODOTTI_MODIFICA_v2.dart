...
class _NuovoPreventivoScreenState extends State<NuovoPreventivoScreen> {
  ...
  Future<void> scegliServizio() async {
    ...
    if (prodotto != null && mounted) {
      ...
      // In modifica, la selezione dal listino deve aggiungere
      // direttamente una nuova riga al preventivo.
      setState(() {
        articoli.add({
          'nome': nome,
          'prezzo': prezzo,
...
class _ModificaPreventivoScreenState
  ...
  Future<void> scegliServizio() async {
    ...
    // In MODIFICA il prodotto scelto dal listino deve essere inserito
    // immediatamente nella lista degli articoli. Non deve soltanto
    // compilare i campi Descrizione e Prezzo.
    setState(() {
      articoli.add({
        'nome': nome,
        'prezzo': prezzo,
